    ...
    && isset($_POST['website']))
{
    ...
    if(empty($username)){
        header("Location: create.php?error=Username is required for login&$user_data");
        exit();
    }
    else if(empty($password)) {
    header("Location: create.php?error=Password is required for login&$user_data");
    exit();
    }
    else if(empty($email)){
    header("Location: create.php?error=Email is required for login&$user_data");
    exit();
    }
    else if(empty($companyname)){
        header("Location: create.php?error=Company name is required&$user_data");
        exit();
    }
        ...
        header("Location: create.php?error=Profile text is required&$user_data");
        exit();
    }
    else if(empty($position)){
        header("Location: create.php?error=Position is required&$user_data");
        exit();
    }
    else if(empty($positiontext)){
        header("Location: create.php?error=Position text is required&$user_data");
        exit();
    }
    else if(empty($video)){
        ...
        header("Location: create.php?error=Logo link is required&$user_data");
        exit();
    }
    else if(empty($contactpersoon)){
        header("Location: create.php?error=Contact person's name is required&$user_data");
        exit();
    }
    else if(!filter_var($email_contactpersoon, FILTER_VALIDATE_EMAIL)){
        header("Location: create.php?error=Contact Person's Email is required&$user_data");
        exit();
    }
    else if(empty($website)){
        header("Location: create.php?error=Website link is required&$user_data");
        exit();
    }
        ...
        $sql = 'INSERT INTO entity(user_id,companyname, street_address,postal_code,city,countryid,profiletext,position,positiontext,video,logo,contactpersoon,email_contactpersoon,website) VALUES(:user_id,:companyname, :street_address,:postal_code,:city,:countryid,:profiletext,:position,:positiontext,:video,:logo,:contactpersoon,:email_contactpersoon,:website)';
        ...
        <div class="container">
            ...
            <div class="col-lg-12">
                ...
                <form method="post" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="profiletext" class="col-sm-3 control-label">Profile text</label>
                        <div class="col-sm-6">
                        <input type="text" name="profiletext" id="profiletext" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="positiontext" class="col-sm-3 control-label">Position text</label>
                        <div class="col-sm-6">
                        <input type="text" name="positiontext" id="positiontext" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="contactpersoon" class="col-sm-3 control-label">Contact person</label>
                        <div class="col-sm-6">
                        <input type="text" name="contactpersoon" id="contactpersoon" class="form-control">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="email_contactpersoon" class="col-sm-3 control-label">Email Contact person</label>
                        <div class="col-sm-6">
                        <input type="email" name="email_contactpersoon" id="email_contactpersoon" class="form-control">
                        </div>
                    </div>
