    ...
    && isset($_POST['website']))
{
    ...
    if(empty($username)){
        ...
        header("Location: create.php?error=Education name is required&$user_data");
        exit();
    }
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
            ...
            <form method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="name" class="col-sm-3 control-label">Education Name</label>
                    <div class="col-sm-6">
