...
if (isset ($_POST['companyname'])
    ...
    if (empty($companyname)) {
        header("Location: entity_home.php?error=Company Name is required&$user_data");
        exit();
    } else if (empty($street_address)) {
        header("Location: entity_home.php?error=Street name is required&$user_data");
        exit();
    } else if (empty($postal_code)) {
        header("Location: entity_home.php?error=Postal code is required&$user_data");
        exit();
    } else if (empty($city)) {
        header("Location: entity_home.php?error=City name is required&$user_data");
        exit();
    } else if (empty($countryid)) {
        header("Location: entity_home.php?error=Country name is required&$user_data");
        exit();
    } else if (empty($profiletext)) {
        header("Location: entity_home.php?error=About you field is required&$user_data");
        exit();
    } else if (empty($position)) {
        header("Location: entity_home.php?error=Position is required&$user_data");
        exit();
    } else if (empty($positiontext)) {
        header("Location: entity_home.php?error=Position text is required&$user_data");
        exit();
    } else if (empty($video)) {
        header("Location: entity_home.php?error=Video link is required&$user_data");
        exit();
    } else if (empty($logo)) {
        header("Location: entity_home.php?error=Logo link is required&$user_data");
        exit();
    } else if (empty($contactpersoon)) {
        header("Location: entity_home.php?error=Contact person's name is required&$user_data");
        exit();
    } else if (!filter_var($email_contactpersoon, FILTER_VALIDATE_EMAIL)) {
        header("Location: entity_home.php?error=Contact person's email is required&$user_data");
        exit();
    } else if (empty($website)) {
        header("Location: entity_home.php?error=Website link is required&$user_data");
        exit();
    } else {

        $sql = 'INSERT INTO entity(user_id,companyname,street_address,postal_code,city,countryid,profiletext,position,positiontext,video,logo,contactpersoon,email_contactpersoon,website) 
                VALUES(:user_id,:companyname,:street_address,:postal_code,:city,:countryid,:profiletext,:position,:positiontext,:video,:logo,:contactpersoon,:email_contactpersoon,:website)';
        ...
        if (intval($last_id) > 0) {
            $message = 'Entity profile completed successfully';
            header("refresh:3;entity_profile.php?id=" . $last_id);
        }
...
<div class="wrapper">
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
            ...
            <center><img src="../assets/logo.png" width="100px"><h2>Entity | Make Profile</h2>
